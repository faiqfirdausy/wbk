...
(13,'a. Dokumen laporan pelaksanaan kegiatan Sosialisasi Zona Integritas kepada pegawai, yang teridiri dari:\r\n<ul>\r\n<li>1) Dokumen Kegiatan Sosialisasi Kepala Satuan Kerja Terkait dengan Pembangunan ZI menuju WBK/ WBBM (Undangan, Notulen, Daftar Hadir, Foto)</li>\r\n<li>2) Laporan kegiatan pendampingan/ pembinaan (Undangan, Notulen, Daftar Hadir, Foto).</li>\r\n<li>3) Capture (Banner dan spanduk)</li>\r\n</ul>',5,NULL),
(14,'b. Laporan Kegiatan sosialisasi langsung kepada masyarakat (Undangan, Notulen, Daftar Hadir, Foto)',5,NULL),
(15,'c. Sosialisasi Kepada Masyarakat\r\n- Capture Banner/spanduk/himbauan/brosur\r\n- Capture Website\r\n- Capture Media Sosial\r\n- Capture Media elektronik\r\n- Capture Media cetak\r\n- Capture Media TV',5,NULL),
(16,'d. Dokumen laporan pelaksanaan kegiatan Pencanangan Zona Integritas, yaitu:\r\n1) Kegiatan Ekternal\r\nPencanangan Zona Integritas melampirkan Foto, Laporan Kegiatan dan Press release.\r\n2) Kegiatan Internal\r\n- Dokumen Perjanjian Kinerja\r\n- Dokumen Penandatanganan Pakta Integritas antara Kepala Satuan Kerja dengan jajaran struktural dibawahnya,\r\n- Dokumen Pakta Integritas Antara jajaran Struktural dalam satuan kerja dengan pegawai',5,NULL),
(17,'a. Dokumen kegiatan penyusunan pelaksanaan Rencana Aksi dan Target Prioritas oleh Tim kerja (Undangan, Notulen, Daftar Hadir, Foto).',6,NULL),
(18,'b. Dokumen laporan kegiatan pembangunan ZI berdasarkan Rencana Aksi dan Target Prioritas yang sudah ditetapkan oleh Tim kerja;',6,NULL),
(19,'a. Absensi pimpinan Satker dan pejabat struktural (Sampling: Bulan Januari, Februari, dan Maret),',7,NULL),
(20,'b. Dokumentasi pimpinan/pejabat struktural menjadi Pembina apel dan pembina upacara.',7,NULL),
(21,'c. Dokumen Jurnal Harian Pimpinan dan Pejabat Struktural (Sampling: Bulan Januari, Februari, dan Maret)\r\n1) Untuk satuan kerja Eselon I, daftar hadir dan jurnal harian yang dibutuhkan sampai kepada Jabatan Struktural Eselon I, II, dan III;\r\n2) Untuk satuan kerja Eselon II, daftar hadir dan jurnal harian yang dibutuhkan sampai kepada Jabatan Struktural Eselon II dan III;\r\n3) Untuk satuan kerja Eselon III, daftar hadir dan jurnal harian yang dibutuhkan sampai kepada Jabatan Struktural Eselon III dan IV.',7,NULL),
(22,'a. SK Agen Perubahan melalui SK Kepala Satuan Kerja;',8,NULL),
(23,'b. Dokumen pelaksanaan kegiatan penetapan Agen Perubahan (Undangan, Notulen, Daftar Hadir, Foto);',8,NULL),
(24,'c. Riwayat Hidup dan rekam jejak agen perubahan.',8,NULL);
...
(2,'kanimblitar','upt','faiqfirdausy17@gmail.com',NULL,'$2y$10$mfp1Vd5q4tseGFV9/0vs/.zDo6aN9POj6q4XO5NEXmRAuaYV8PbZ2','RStd4iHuyYV4PkgiJkq0H0sZnSJ216ASaC6WDIrmEGCIzxcspngWSYmIGUa8','2019-02-12 14:08:12','2019-02-18 06:06:04',50,1),
